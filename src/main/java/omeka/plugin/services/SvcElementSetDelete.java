...
public class SvcElementSetDelete extends OmekaPluginService {

    public static final String SERVICE_NAME = "omeka.element_set.delete";

    public SvcElementSetDelete() {
    ...
    protected void execute(OmekaClient omekaClient, Element args, Inputs inputs, Outputs outputs, XmlWriter w)
        ...
        omekaClient.deleteElementSet(id);
    }
