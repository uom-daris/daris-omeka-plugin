...
public class SvcElementDelete extends OmekaPluginService {

    public static final String SERVICE_NAME = "omeka.element.delete";

    public SvcElementDelete() {
